...
Na versão `0.4.1`, o RouteLens oferece:
...
Versão **0.4.1** pronta como V4 Multi-framework com melhorias de qualidade.
...
A versão `0.4.1` adiciona testes automatizados dos parsers, CI com `npm test` e empacotamento validado com `npm run package`.
